...
describe('Anarchy builtin plugins', () => {
  ...
  it('persists spawn, homes, back, and home limits', async () => {
    ...
    chat(world, ada, '/sethome farm');
    expect(chat(world, ada, '/sethome extra').some((line) => line.includes('максимальное количество домов: 4'))).toBe(true);
    chat(world, ada, '/delhome farm');
