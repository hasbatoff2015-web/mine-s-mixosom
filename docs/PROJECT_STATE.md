...
| Automated QA | Частично готово | 156 unit/component tests in 22 files, reproducible performance benchmark and visual browser scenes; no automated WebGL, IndexedDB or full browser E2E suite |
