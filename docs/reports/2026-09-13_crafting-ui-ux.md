...
- Close control is a square `.mc-close` (20 logical px): large red × inside the button, small white **E** in the bottom-right corner. No wrap and no E outside. Clan ← still has no E.
