...
PluginManager.scopedApi (permissions, teleport, config, data, help)
        │
        ▼
builtin-plugins (permissions, tpa, spawn, home, friends, trade, menu, back, rtp, rtpportal, claims, holograms, automine, economy, auction, clan, buyer)
