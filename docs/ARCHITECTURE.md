...
PluginManager.scopedApi (permissions, teleport, config, data, help)
        │
        ▼
builtin-plugins (permissions, tpa, spawn, home, back, rtp, rtpportal, claims, holograms, automine, economy, auction, clan, buyer)
...
**Not here:** kits / bidding auctions. Homes, TPA, claims, holograms, AutoMine, Economy, Auction House, Clans, and Buyers **are** the current Anarchy plugin pack.
