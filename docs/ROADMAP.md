...
- [x] Block-break path: skip lighting when opacity+emission unchanged; localized sky columns instead of 6-pass overlapping chunks; light writes no longer dirty neighbor meshes.
