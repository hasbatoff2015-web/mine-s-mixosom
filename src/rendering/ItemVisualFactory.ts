  ...
  private specialHeldGeometry(itemId: string): THREE.BufferGeometry {
    ...
    switch (block.renderShape) {
      ...
      case 'rail':
        ...
        break;
      case 'lantern':
        geometry = this.geometryFromLocalBoxes(lanternHeldLocalBoxes(), texture);
        break;
      case 'chain':
        geometry = this.geometryFromLocalBoxes(chainHeldLocalBoxes(), texture);
        break;
      default:
