...
export function tradeMoneyCaption(amount: number | string | undefined): string {
  return `Монет: ${amount ?? 0}`;
}
  ...
  return `<div class="mc-menu-body mc-trade-body" data-trade-screen="session">
    ...
    <div class="mc-trade-boards">
      <div class="mc-trade-side">
        ...
        <label class="mc-ah-field mc-trade-money">Монет:
      ...
      <div class="mc-trade-side">
        ...
        <div class="mc-trade-money mc-trade-money-partner" data-trade-partner-money>${escape(tradeMoneyCaption(state.partnerMoneyText ?? state.partnerMoney))}</div>
      </div>
    </div>
