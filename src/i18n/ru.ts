...
export const RU_DISPLAY_NAMES: Readonly<Record<string, string>> = Object.freeze({
  ...
  diamond: 'Алмаз',
  ruby_ingot: 'Рубиновый слиток',
  titanium_ingot: 'Титановый слиток',
  ...
  ruby_pickaxe: 'Рубиновая кирка',
  ruby_axe: 'Рубиновый топор',
  ruby_shovel: 'Рубиновая лопата',
  ruby_sword: 'Рубиновый меч',
  titanium_pickaxe: 'Титановая кирка',
  ...
  ruby_hoe: 'Рубиновая мотыга',
  titanium_hoe: 'Титановая мотыга',
  bow: 'Лук',
  ...
  ruby_helmet: 'Рубиновый шлем',
  ruby_chestplate: 'Рубиновый нагрудник',
  ruby_leggings: 'Рубиновые поножи',
  ruby_boots: 'Рубиновые ботинки',
  titanium_helmet: 'Титановый шлем',
